...
public class JoueurLowatemTest {
    ...
    public void testActionsPossibles_niveau3() {
        ...
        actionsPossibles.afficher();
        // on peut aussi tester si une action est dans les actions possibles :
        assertTrue(actionsPossibles.contient("bCDbE,27,0"));
        assertTrue(actionsPossibles.contient("eIDaI,27,0"));
        assertTrue(!actionsPossibles.contient("eIDgI,23,0"));
        // on peut aussi tester si une action n'est pas dans les actions possibles :
        assertFalse(actionsPossibles.contient("bCDnC,27,0"));
        assertFalse(actionsPossibles.contient("bcDbE,9,0"));
    }
    ...
    public void testActionsPossibles_niveau4() {
        ...
        actionsPossibles.afficher();
        // on peut aussi tester si une action est dans les actions possibles :
        assertTrue(actionsPossibles.contient("bCDbE,27,27"));
        assertTrue(actionsPossibles.contient("eIDaI,27,27"));
        assertTrue(!actionsPossibles.contient("eIDgI,23,18"));
        // on peut aussi tester si une action n'est pas dans les actions possibles :
        assertFalse(actionsPossibles.contient("bJDfJ,27,27"));
        assertFalse(actionsPossibles.contient("gDDdD,27,27"));
    }
    ...
    public void testActionsPossibles_niveau5() {
        ...
        actionsPossibles.afficher();
        // on peut aussi tester si une action est dans les actions possibles :
        assertTrue(actionsPossibles.contient("jBDjBAkB,17,17"));
    }
    ...
    public void testActionsPossibles_niveau6() {
        ...
        actionsPossibles.afficher();
        // on peut aussi tester si une action est dans les actions possibles :
        assertTrue(actionsPossibles.contient("nEDnLAnM,57,59"));
        // on peut aussi tester si une action n'est pas dans les actions possibles :
        assertFalse(actionsPossibles.contient("bBDbCAcC,61,61"));
    }
